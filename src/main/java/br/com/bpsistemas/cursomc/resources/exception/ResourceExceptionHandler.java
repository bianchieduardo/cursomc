package br.com.bpsistemas.cursomc.resources.exception;
...
import br.com.bpsistemas.cursomc.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> authorization(AuthorizationException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.FORBIDDEN.value(), "Acersso negado", e.getMessage(), request.getRequestURI());
